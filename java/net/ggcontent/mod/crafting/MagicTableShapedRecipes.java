...
public class MagicTableShapedRecipes implements IRecipe
{
    ...
    public MagicTableShapedRecipes(int par1, int par2, ItemStack[] par3ArrayOfItemStack, ItemStack par4ItemStack)
    {
    ...
    public MagicTableShapedRecipes func_92100_c()
    {
