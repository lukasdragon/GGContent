package net.ggcontent.mod.container;

import net.ggcontent.mod.Ggcontent;
import net.ggcontent.mod.crafting.MagicTableCraftingManager;
...
public class ContainerMagicTable extends Container {
	...
	public ContainerMagicTable(InventoryPlayer invPlayer, World world, int x, int y, int z) {
	...
	public boolean canInteractWith(EntityPlayer player) {
		if(worldObj.getBlock(posX, posY, posZ) != Ggcontent.blockMagicTable) {
			return false;
		}else{
